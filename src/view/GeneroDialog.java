...
public class GeneroDialog extends javax.swing.JDialog {
    ...
    Main pai;
    Toast msg;
    List<Genero> list_atual;
    GeneroDAOImplement daoObject;

    public GeneroDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        pai = (Main) parent;
        daoObject = pai.control.getGeneroDAO();
    ...
    public void addRowTableModel(DefaultTableModel model, Genero obj) {
    ...
    public void updateJTable() {
        ...
        model.setNumRows(0);
        try {
            List<Genero> list = daoObject.findAll();
            list_atual = list;
            for (Genero obj : list) {
    ...
    public void updateJTableBusca(List<Genero> list) {
        DefaultTableModel model = (DefaultTableModel) tabela.getModel();
        model.setNumRows(0);
        for (Genero obj : list) {
            addRowTableModel(model, obj);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (nome.getText().equals("")) {
            ...
            Genero obj = new Genero(nome.getText());
            try {
                daoObject.save(obj);
                updateJTable();
                pai.control.messageOperacaoSucesso();
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
        Genero obj = list_atual.get(tabela.getSelectedRow());
    ...
    private void botao_actualizar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botao_actualizar1ActionPerformed
        ...
        if (opcao == JOptionPane.YES_OPTION) {
            ...
            if (rows.length > 0) {
                if (rows.length == 1) {
                    Genero obj = list_atual.get(rows[0]);
                    editar(obj);                    
                } else {
