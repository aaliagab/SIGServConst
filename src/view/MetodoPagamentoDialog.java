 ...
 * @author
 */
public class MetodoPagamentoDialog extends javax.swing.JDialog {
    ...
    Main pai;
    Toast msg;
    List<MetodoPagamento> list_atual;
    MetodoPagamentoDAOImplement daoObject;

    public MetodoPagamentoDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        pai = (Main) parent;
        daoObject = pai.control.getMetodoPagamentoDAO();
    ...
    public void addRowTableModel(DefaultTableModel model, MetodoPagamento obj) {
    ...
    public void updateJTable() {
        ...
        model.setNumRows(0);
        try {
            List<MetodoPagamento> list = daoObject.findAll();
            list_atual = list;
            for (MetodoPagamento obj : list) {
    ...
    public void updateJTableBusca(List<MetodoPagamento> list) {
        DefaultTableModel model = (DefaultTableModel) tabela.getModel();
        model.setNumRows(0);
        for (MetodoPagamento obj : list) {
            addRowTableModel(model, obj);
    ...
    public void editar(MetodoPagamento obj) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (nome.getText().equals("")) {
            ...
            MetodoPagamento obj = new MetodoPagamento(nome.getText());
            try {
                daoObject.save(obj);
                updateJTable();
                pai.control.messageOperacaoSucesso();
    ...
    private void busca_nomeKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_busca_nomeKeyPressed
        ...
        updateJTable();
        boolean flag = false;
        for (MetodoPagamento list1 : list_atual) {
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
        MetodoPagamento obj = list_atual.get(tabela.getSelectedRow());
    ...
    private void botao_actualizar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botao_actualizar1ActionPerformed
        ...
        if (opcao == JOptionPane.YES_OPTION) {
            ...
            if (rows.length > 0) {
                if (rows.length == 1) {
                    MetodoPagamento obj = list_atual.get(rows[0]);
                    editar(obj);                    
                } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MetodoPagamentoDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MetodoPagamentoDialog dialog = new MetodoPagamentoDialog(new javax.swing.JFrame(), true);
