 ...
 * @author
 */
public class BilheteDialog extends javax.swing.JDialog {
    ...
    List<Tipo> tipos;
    List<Iva> ivas;
    BilheteDAOImplement daoObject;

    public BilheteDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        pai = (Main) parent;
        daoObject = pai.control.getBilheteDAO();
    ...
    public void addRowTableModel(DefaultTableModel model, Bilhete obj) {
    ...
    private void initComponents() {
        ...
        tabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome", "Tipo", "Valor", "IVA", "Quantidade", "Data de criação"
            }
        ) {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(jScrollPane1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 1154, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void botao_actualizar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botao_actualizar1ActionPerformed
        ...
        if (opcao == JOptionPane.YES_OPTION) {
            ...
            if (rows.length > 0) {
                if (rows.length == 1) {
                    Bilhete obj = list_atual.get(rows[0]);
                    editar(obj);
                } else {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (opcao == JOptionPane.YES_OPTION) {
            try {
                ...
                if (rows.length != 0) {
                    for (int indice : rows) {
                        pai.control.getBilheteDAO().delete(list_atual.get(indice).getId());
                    }
                    inicializarForm();
                    updateJTable();
                    pai.control.messageOperacaoSucesso();
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
        Bilhete obj = list_atual.get(tabela.getSelectedRow());
        nome.setText(obj.getNome());
        valor.setText(obj.getValor()+"");
        quantidade.setValue(obj.getQuantidade()+"");
        comboIva.setSelectedItem(obj.getIva()!=null?obj.getIva().getPorcetagem()+" %":"-------");
        comboTipo.setSelectedItem(obj.getTipo().getNome());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BilheteDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BilheteDialog dialog = new BilheteDialog(new javax.swing.JFrame(), true);
